...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($password)) {
        if ($password !== $confirmPassword) {
            ...
            $sql = "UPDATE accounts SET username=?, email=?, phone=?, password=? WHERE id=? AND role='user'";
        ...
        $sql = "UPDATE accounts SET username=?, email=?, phone=? WHERE id=? AND role='user'";
        $stmt = $conn->prepare($sql);
...
$sql = "SELECT * FROM accounts WHERE id=? AND role='user'";
$stmt = $conn->prepare($sql);
